    ...
    <h1 class="title">Álbumes</h1>
     <?php
            ...
            try {
                ...
                echo "<form action='albumes.php' method='GET' class='mb-4 d-flex flex-column align-items-center'>";
                ...
                while($fila = mysqli_fetch_array($resultado)) {
                    echo  
                            "<div class='col-12 col-md-6 col-xl-4 d-flex justify-content-center mb-5'>
                                    <div class='card mt-5' style='width: 18rem;'>
                                        <img src='$ruta$fila[portada]' class='card-img-top' alt='Portada de $fila[titulo]' title='$fila[titulo]'>
                                        <div class='card-body text-center'>
                                            <h5 class='card-title'>$fila[titulo]</h5>
                                            <a href='canciones.php?cod_album=$fila[cod_album]' class='btn btn-outline-primary mt-2'>Ver temas</a>
                                        </div>
                                    </div>
                            </div>";
